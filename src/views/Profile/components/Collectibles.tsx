...
const Collectibles = () => {
  ...
  return (
    <>
      ...
      <Text as="p">
        {t('Pancake Collectibles are special ERC-721 NFTs that can be used on the Mochiswap platform.')}
      </Text>
      <Text as="p">
        {t('NFTs in this user’s wallet that aren’t approved Mochiswap Collectibles won’t be shown here.')}
      </Text>
