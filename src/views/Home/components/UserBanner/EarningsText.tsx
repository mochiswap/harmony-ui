...
export const getEarningsText = (
  ...
  if (numFarmsToCollect > 0 && hasCakePoolToCollect) {
    if (numFarmsToCollect > 1) {
      earningsText = t('%earningsBusd% to collect from %count% farms and hMOCHI pool', data)
    } else {
      earningsText = t('%earningsBusd% to collect from %count% farm and hMOCHI pool', data)
    }
    ...
    earningsText = t('%earningsBusd% to collect from hMOCHI pool', data)
  }
