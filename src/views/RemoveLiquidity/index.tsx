...
export default function RemoveLiquidity({
  ...
  async function onAttemptToApprove() {
    ...
    // V1 name: "Mochi LP Token"
    // V2 WAS in error name: "MochiSwap LP" for a short time.
    // console.log('xxxxxxxxxxxxxxxxxxxxxxxxxxxx')
    // console.log('pair symbol:', pair.liquidityToken.symbol)
    // console.log('pair name:', pair.liquidityToken.name)
  ...
  function modalHeader() {
    return (
      <AutoColumn gap="md">
        ...
        <Text small textAlign="left" pt="12px" pb="10px">
          {t('NOTE: If you have issues removing liquidity use the old DEX (V1 Farms link in menu)', {
            slippage: allowedSlippage / 100,
          })}
        </Text>
      </AutoColumn>
                  ...
                  {chainId && (oneCurrencyIsWETH || oneCurrencyIsETH) ? (
                    <RowBetween style={{ justifyContent: 'flex-end', fontSize: '14px' }}>
                      {oneCurrencyIsETH ? (
                        ...
                        <StyledInternalLink
                          to={`/remove/${currencyA && currencyEquals(currencyA, WETH[chainId]) ? 'ONE' : currencyIdA}/${
